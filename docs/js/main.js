...
function checkInput() {
  if (document.getElementById("tipue_search_input").value.length > 3) {
    ...
    vis.typingTimeout = setTimeout(function () {
      vis.initSiteSearch(true);
    }, 200);
  } else {
 ...
 * @author felixhayashi
 */
vis.initSiteSearch = function (dynamic) {
  // Added dynamic flag for live update ~ Alex
