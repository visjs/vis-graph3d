...
function textToComment(string) {
  ...
  if (includes$4(string).call(string, "*/")) {
    throw new Error("Don't include comments in the input string. It will be converted automatically.");
  }

  return "/**\n" + map$2(_context = map$2(_context2 = string // Remove empty lines from the start.
...
export { generateHeader, textToComment };
