(function (global, factory) {
    ...
    (global = global || self, factory(global.samsam = {}, global.commons, global.lodash));
    ...
    function isIterable(value) {
        return Boolean(value) && typeOf$2(value.forEach) === "function";
    }
    ...
    var TYPE_MAP = {
        ...
        object: function(m, expectation) {
            ...
            m.test = function(actual) {
                return matchObject_1(actual, expectation);
            };
    ...
    function createMatcher(expectation, message) {
        ...
        if (type in typeMap) {
            typeMap[type](m, expectation, message);
        } else {
            m.test = function(actual) {
    ...
    createMatcher.in = function(arrayOfExpectations) {
        if (typeOf$4(arrayOfExpectations) !== "array") {
    ...
    createMatcher.instanceOf = function(type) {
        ...
        }, "instanceOf(" + (functionName$1(type) || objectToString(type)) + ")");
    };
    ...
    createMatcher.array.deepEquals = function(expectation) {
        return createMatcher(function(actual) {
            ...
            return (
                typeOf$4(actual) === "array" &&
                sameLength &&
                every$2(actual, function(element, index) {
                    var expected = expectation[index];
                    return typeOf$4(expected) === "array" &&
                        typeOf$4(element) === "array"
    ...
    var indexOf$1 = commons.prototypes.string.indexOf;
    ...
    function match(object, matcherOrValue) {
        ...
        if (getClass_1(object) === "Array" && getClass_1(matcherOrValue) === "Array") {
            return arrayContains(object, matcherOrValue, match);
        }

        if (isDate_1(matcherOrValue)) {
            return isDate_1(object) && object.getTime() === matcherOrValue.getTime();
        }
