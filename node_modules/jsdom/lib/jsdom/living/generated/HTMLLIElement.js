...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLLIElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  class HTMLLIElement extends globalObject.HTMLElement {
    ...
    get value() {
      ...
      try {
        const value = parseInt(this[impl].getAttributeNS(null, "value"));
    ...
    set value(V) {
      ...
      ceReactionsPreSteps_helpers_custom_elements(globalObject);
      try {
        this[impl].setAttributeNS(null, "value", String(V));
      } finally {
        ceReactionsPostSteps_helpers_custom_elements(globalObject);
      }
    }
  ...
  globalObject[ctorRegistry][interfaceName] = HTMLLIElement;
