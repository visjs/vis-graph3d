...
<body>
	<div class=content>
		<div class=side-links>
			<a href="https://travis-ci.org/joebain/args.js" id=travis-status><img alt="Travis CI" src="https://travis-ci.org/joebain/args.js.png?branch=master"></a>
			<iframe src="http://ghbtns.com/github-btn.html?user=joebain&repo=args.js&type=fork&count=true"
				allowtransparency="true" frameborder="0" scrolling="0" width="90" height="20"></iframe>
			<iframe src="http://ghbtns.com/github-btn.html?user=joebain&repo=args.js&type=watch&count=true"
				allowtransparency="true" frameborder="0" scrolling="0" width="90" height="20"></iframe>
		</div>
		<h1>Args.js</h1>
...
addBook("Frankenstein", 5);
		...
		<h2>Download</h2>
		<p>
		<a class=button href="https://raw2.github.com/joebain/args.js/master/dist/Args.js">Full</a> (12.0k) <a class=button href="https://raw2.github.com/joebain/args.js/master/dist/Args.min.js">Minified</a> (4.1k)
		</p>
		<p>
		&nbsp;
		</p>
...
myFunc("Wuthering Heights", "A book about love and rain.");
        ...
        It is also possible to make an argument group optional by including an <code>Args.Optional</code> in the group, this means a positional argument will be taken if possible, but the group is skipped otherwise:
		<pre><code class="language-javascript">
...
myFunc({
	...
	rating: 5
        ...
        <b>Note:</b> If the last argument you pass is a simple object which has a property with the same name and type of one of your other arguments Args.js will assume you are trying to use named arguments. So for example, this will cause problems:
		<pre><code class="language-javascript">
function myFunc() {
	var args = Args([
		{book:        Args.OBJECT | Args.Required},
...
var args = Args([
	...
	{title:    Args.STRING   | Args.Required}
		...
		<h3>Regex Checks</h3>
        For arguments which have a sensible <code>toString()</code> representation you can pass a regular expression as a custom checker. This trys to match the regex to the string value of an argument.
		<pre><code class="language-javascript">
var args = Args([
...
Args.ARRAY        
		...
		<h2>Credits</h2>
		By <a href="http://joeba.in">Joe Bain</a>
	</div>
</body>
