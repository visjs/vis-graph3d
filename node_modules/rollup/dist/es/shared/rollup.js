...
class NamespaceVariable extends Variable {
    constructor(context, syntheticNamedExports) {
        ...
        this.reexportedExternalNamespaces = [];
    ...
    renderBlock(options) {
        ...
        if (hasExternalReexports || this.syntheticNamedExports) {
            ...
            if (hasExternalReexports) {
                assignmentArgs.unshift('/*#__PURE__*/Object.create(null)', ...this.reexportedExternalNamespaces.map(variable => variable.getName()));
            }
...
class Module {
    ...
    setSource({ alwaysRemovedCode, ast, code, customTransformCache, moduleSideEffects, originalCode, originalSourcemap, resolvedIds, sourcemapChain, syntheticNamedExports, transformDependencies, transformFiles }) {
        ...
        this.astContext = {
            ...
            includeAndGetReexportedExternalNamespaces: this.includeAndGetReexportedExternalNamespaces.bind(this),
    ...
    includeAndGetReexportedExternalNamespaces() {
        const reexportedExternalNamespaces = [];
        for (const module of this.exportAllModules) {
            if (module instanceof ExternalModule) {
...
export { parseOutputOptions as a, warnUnknownOptions as b, createCommonjsModule as c, rollupInternal as d, ensureArray as e, getCjsExportFromNamespace as g, parseInputOptions as p, rollup as r, unwrapExports as u, version as v, watch as w };
