...
var entries_1 = function (it) {
  var own = it.entries;
  return it === ArrayPrototype$1 || it instanceof Array && own === ArrayPrototype$1.entries // eslint-disable-next-line no-prototype-builtins
...
var sort_1 = function (it) {
  var own = it.sort;
  return it === ArrayPrototype$3 || it instanceof Array && own === ArrayPrototype$3.sort ? sort : own;
};
...
var concat_1 = function (it) {
  var own = it.concat;
  return it === ArrayPrototype$8 || it instanceof Array && own === ArrayPrototype$8.concat ? concat : own;
};
...
var symbol$1 = symbol; // TODO: Remove from `core-js@4`

var symbol$2 = symbol$1;

var _typeof_1 = createCommonjsModule(function (module) {
  function _typeof2(obj) {
    if (typeof symbol$2 === "function" && typeof iterator$4 === "symbol") {
  ...
  function _typeof(obj) {
    if (typeof symbol$2 === "function" && _typeof2(iterator$4) === "symbol") {
...
var FORCED$4 = !descriptors$1 || FAILS_ON_PRIMITIVES$3; // `Object.getOwnPropertyDescriptor` method
// https://tc39.github.io/ecma262/#sec-object.getownpropertydescriptor
...
var wellKnownSymbol$1 = function (name) {
  return store$1$1[name] || (store$1$1[name] = nativeSymbol$1 && Symbol$1$1[name] || (nativeSymbol$1 ? Symbol$1$1 : uid$1)('Symbol.' + name));
};
...
var defineWellKnownSymbol$1 = function (NAME) {
  ...
  if (!has$2(Symbol, NAME)) defineProperty$2$1(Symbol, NAME, {
...
var test$2 = {};
test$2[TO_STRING_TAG$1$1] = 'z'; // `Object.prototype.toString` method implementation
// https://tc39.github.io/ecma262/#sec-object.prototype.tostring

var objectToString$1 = String(test$2) !== '[object z]' ? function toString() {
...
var setToStringTag$1 = function (it, TAG, STATIC, SET_METHOD) {
  if (it) {
    ...
    if (!has$2(target, TO_STRING_TAG$2$1)) {
      defineProperty$3$1(target, TO_STRING_TAG$2$1, {
        configurable: true,
        value: TAG
      });
    }
...
if (nativeWeakMap$1) {
  var store$2$1 = new WeakMap$1$1();
  var wmget$1 = store$2$1.get;
  var wmhas$1 = store$2$1.has;
  var wmset$1 = store$2$1.set;

  set$1 = function (it, metadata) {
    wmset$1.call(store$2$1, it, metadata);
    return metadata;
  };

  get$1 = function (it) {
    return wmget$1.call(store$2$1, it) || {};
  };

  has$1$1 = function (it) {
    return wmhas$1.call(store$2$1, it);
  };
} else {
...
var arraySpeciesCreate$1 = function (originalArray, length) {
  ...
  if (isArray$6(originalArray)) {
    ...
    if (typeof C == 'function' && (C === Array || isArray$6(C.prototype))) C = undefined;else if (isObject$1(C)) {
      C = C[SPECIES$3];
      if (C === null) C = undefined;
    }
  }
...
var setSymbolDescriptor$1 = descriptors$1 && fails$1(function () {
  ...
  var ObjectPrototypeDescriptor = nativeGetOwnPropertyDescriptor$2$1(ObjectPrototype$2, P);
...
var $propertyIsEnumerable$1 = function propertyIsEnumerable(V) {
  ...
  if (this === ObjectPrototype$2 && has$2(AllSymbols$1, P) && !has$2(ObjectPrototypeSymbols$1, P)) return false;
...
var $getOwnPropertyDescriptor$1 = function getOwnPropertyDescriptor(O, P) {
  ...
  var key = toPrimitive$1(P, true);
  if (it === ObjectPrototype$2 && has$2(AllSymbols$1, key) && !has$2(ObjectPrototypeSymbols$1, key)) return;
...
var $getOwnPropertySymbols$1 = function getOwnPropertySymbols(O) {
  ...
  var result = [];
  $forEach$2(names, function (key) {
    if (has$2(AllSymbols$1, key) && (!IS_OBJECT_PROTOTYPE || has$2(ObjectPrototype$2, key))) {
...
if (!nativeSymbol$1) {
  $Symbol$1 = function Symbol() {
    ...
    if (descriptors$1 && USE_SETTER$1) setSymbolDescriptor$1(ObjectPrototype$2, tag, {
      configurable: true,
      set: setter
    });
...
var keys$1$1 = path$1.Object.keys;
var keys$2$1 = keys$1$1;
var keys$3$1 = keys$2$1; // a string of all valid unicode whitespaces
...
var trim = entryVirtual$1('String').trim;
...
var $forEach$1$1 = arrayIteration$1.forEach; // `Array.prototype.forEach` method implementation
// https://tc39.github.io/ecma262/#sec-array.prototype.foreach
...
var forEach_1$1 = function (it) {
  ...
  || DOMIterables$4.hasOwnProperty(classof$1(it)) ? forEach$1$1 : own;
};
...
var hex = /^[+-]?0[Xx]/;
var FORCED$1$1 = nativeParseInt(whitespaces + '08') !== 8 || nativeParseInt(whitespaces + '0x16') !== 22; // `parseInt` method
// https://tc39.github.io/ecma262/#sec-parseint-string-radix

var _parseInt = FORCED$1$1 ? function parseInt(string, radix) {
...
var _parseInt$1 = path$1.parseInt;
...
var createMethod$4$1 = function (TO_ENTRIES) {
  return function (it) {
...
var objectToArray = {
  ...
  entries: createMethod$4$1(true),
  // `Object.values` method
  // https://tc39.github.io/ecma262/#sec-object.values
  values: createMethod$4$1(false)
};
...
var values$3 = path$1.Object.values;
...
var FORCED$2$1 = !IS_CONCAT_SPREADABLE_SUPPORT$1 || !SPECIES_SUPPORT$1; // `Array.prototype.concat` method
// https://tc39.github.io/ecma262/#sec-array.prototype.concat
// with adding support of @@isConcatSpreadable and @@species
...
var concat_1$1 = function (it) {
  var own = it.concat;
  return it === ArrayPrototype$3$1 || it instanceof Array && own === ArrayPrototype$3$1.concat ? concat$3 : own;
};

var concat$1$1 = concat_1$1;
var concat$2$1 = concat$1$1; // `Array.isArray` method
// https://tc39.github.io/ecma262/#sec-array.isarray
...
var ArrayPrototype$4$1 = Array.prototype; // check on default Array iterator

var isArrayIteratorMethod$1 = function (it) {
  return it !== undefined && (iterators$1.Array === it || ArrayPrototype$4$1[ITERATOR$3$1] === it);
...
_export$1({
  target: 'Array',
  proto: true,
  forced: !arrayMethodHasSpeciesSupport$1('slice')
}, {
...
var slice$1 = entryVirtual$1('Array').slice;
var ArrayPrototype$5$1 = Array.prototype;

var slice_1 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$5$1 || it instanceof Array && own === ArrayPrototype$5$1.slice ? slice$1 : own;
};

var slice$1$1 = slice_1;
var slice$2 = slice$1$1;
...
var getPrototypeOf$1$1 = getPrototypeOf$4;
...
var indexOf_1 = function (it) {
  var own = it.indexOf;
  return it === ArrayPrototype$6$1 || it instanceof Array && own === ArrayPrototype$6$1.indexOf ? indexOf$1$1 : own;
};
...
var iterator$2$1 = iterator$1$1; // `Symbol.asyncIterator` well-known symbol
// https://tc39.github.io/ecma262/#sec-symbol.asynciterator

defineWellKnownSymbol$1('asyncIterator'); // `Symbol.hasInstance` well-known symbol
// https://tc39.github.io/ecma262/#sec-symbol.hasinstance
...
var symbol$3 = path$1.Symbol; // `Symbol.asyncDispose` well-known symbol
// https://github.com/tc39/proposal-using-statement
...
var _typeof_1$1 = createCommonjsModule$1(function (module) {
  ...
  function _typeof(obj) {
    if (typeof symbol$2$1 === "function" && _typeof2(iterator$2$1) === "symbol") {
      module.exports = _typeof = function _typeof(obj) {
        return _typeof2(obj);
      };
    } else {
...
var FORCED$3$1 = 1 / nativeParseFloat(whitespaces + '-0') !== -Infinity; // `parseFloat` method
// https://tc39.github.io/ecma262/#sec-parsefloat-string

var _parseFloat = FORCED$3$1 ? function parseFloat(string) {
...
var _parseFloat$1 = path$1.parseFloat;
...
var SLOPPY_METHOD$1$1 = sloppyArrayMethod$1('sort');
var FORCED$4$1 = FAILS_ON_UNDEFINED$1 || !FAILS_ON_NULL$1 || SLOPPY_METHOD$1$1; // `Array.prototype.sort` method
// https://tc39.github.io/ecma262/#sec-array.prototype.sort
...
var sort_1$1 = function (it) {
  var own = it.sort;
  return it === ArrayPrototype$7$1 || it instanceof Array && own === ArrayPrototype$7$1.sort ? sort$3 : own;
};

var sort$1$1 = sort_1$1;
var sort$2$1 = sort$1$1;
var nativeIsFrozen = Object.isFrozen;
var FAILS_ON_PRIMITIVES$3$1 = fails$1(function () {
  nativeIsFrozen(1);
...
_export$1({
  target: 'Object',
  stat: true,
  forced: FAILS_ON_PRIMITIVES$3$1
}, {
...
var isFrozen = path$1.Object.isFrozen;
var isFrozen$1 = isFrozen;
var isFrozen$2 = isFrozen$1;
var $some$1 = arrayIteration$1.some; // `Array.prototype.some` method
// https://tc39.github.io/ecma262/#sec-array.prototype.some
...
_export$1({
  ...
  getOwnPropertyNames: nativeGetOwnPropertyNames$2$1
});
...
var moment = createCommonjsModule$1(function (module, exports) {
  (function (global, factory) {
      ...
      return extend(function () {
        ...
        if (firstTime) {
          ...
          for (var i = 0; i < arguments.length; i++) {
            ...
            if (_typeof_1$1(arguments[i]) === 'object') {
              arg += '\n[' + i + '] ';
    ...
    function shiftWeekdays(ws, n) {
      ...
      return concat$2$1(_context = slice$2(ws).call(ws, n, 7)).call(_context, slice$2(ws).call(ws, 0, n));
    }
    ...
    function defineLocale(name, config) {
      if (config !== null) {
        ...
        if (localeFamilies[name]) {
          ...
          forEach$2$1(_context2 = localeFamilies[name]).call(_context2, function (x) {
    ...
    function createDuration(input, key) {
      ...
      if (isDuration(input)) {
        ...
        duration = {};
      } else if (_typeof_1$1(duration) === 'object' && ('from' in duration || 'to' in duration)) {
...
function deepExtend(a, b) {
  ...
  for (var prop in b) {
    if (Object.prototype.hasOwnProperty.call(b, prop) || protoExtend === true) {
      if (_typeof_1$1(b[prop]) === "object" && b[prop] !== null && getPrototypeOf$2$1(b[prop]) === Object.prototype) {
        if (a[prop] === undefined) {
          a[prop] = deepExtend({}, b[prop], protoExtend); // NOTE: allowDeletion not propagated!
        } else if (_typeof_1$1(a[prop]) === "object" && a[prop] !== null && getPrototypeOf$2$1(a[prop]) === Object.prototype) {
          deepExtend(a[prop], b[prop], protoExtend); // NOTE: allowDeletion not propagated!
        } else {
          copyOrDelete(a, b, prop, allowDeletion);
        }
      } else if (isArray$5$1(b[prop])) {
        var _context;
...
function () {
  ...
  createClass(DataStream, [{
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 3;
              _iterator = getIterator$2(this._pairs);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 3;
              _iterator2 = getIterator$2(this._pairs);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 3;
              _iterator3 = getIterator$2(this._pairs);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.prev = 3;
              _iterator4 = getIterator$2(this._pairs);
    ...
    value: function toObjectMap() {
      ...
      try {
        for (var _iterator5 = getIterator$2(this._pairs), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
    ...
    value: function distinct(callback) {
      ...
      try {
        for (var _iterator6 = getIterator$2(this._pairs), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
    ...
    value: function filter(callback) {
      ...
      return new DataStream(defineProperty$6({}, iterator$2,
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.prev = 3;
                _iterator7 = getIterator$2(pairs);
    ...
    value: function forEach(callback) {
      ...
      try {
        for (var _iterator8 = getIterator$2(this._pairs), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                _context8.prev = 3;
                _iterator9 = getIterator$2(pairs);
    ...
    value: function max(callback) {
      var iter = getIterator$2(this._pairs);
    ...
    value: function reduce(callback, accumulator) {
      ...
      try {
        for (var _iterator10 = getIterator$2(this._pairs), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
    ...
    value: function sort(callback) {
      ...
      return new DataStream(defineProperty$6({}, iterator$2, function () {
        var _context9;

        return getIterator$2(sort$2(_context9 = toConsumableArray(_this._pairs)).call(_context9, function (_ref3, _ref4) {
...
function ownKeys$2(object, enumerableOnly) { var keys = keys$6(object); if (getOwnPropertySymbols$2) { var symbols = getOwnPropertySymbols$2(object); if (enumerableOnly) symbols = filter$2(symbols).call(symbols, function (sym) { return getOwnPropertyDescriptor$3(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context9; forEach$2(_context9 = ownKeys$2(source, true)).call(_context9, function (key) { defineProperty$6(target, key, source[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source)); } else { var _context10; forEach$2(_context10 = ownKeys$2(source)).call(_context10, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source, key)); }); } } return target; }
/**
 * # DataSet
 *
...
function (_DataSetPart) {
  ...
  function DataSet(data, options) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf$3(DataSet).call(this)); // correctly read optional arguments
  ...
  createClass(DataSet, [{
    ...
    value: function max(field) {
      ...
      try {
        for (var _iterator = getIterator$2(values$2(_context5 = this._data).call(_context5)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var _context5;
    ...
    value: function min(field) {
      ...
      try {
        for (var _iterator2 = getIterator$2(values$2(_context6 = this._data).call(_context6)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var _context6;
    ...
    value: function stream(ids) {
      if (ids) {
        ...
        return new DataStream(defineProperty$6({}, iterator$2, bind$2(_context8 = entries$2(this._data)).call(_context8, this._data)));
      }
    }
  }]);
...
function (_DataSetPart) {
  ...
  function DataView(data, options) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf$3(DataView).call(this));
    /** @inheritdoc */
  ...
  createClass(DataView, [{
    ...
    value: function stream(ids) {
      ...
      return this._data.stream(ids || defineProperty$6({}, iterator$2, bind$2(_context4 = keys$3(this._ids)).call(_context4, this._ids)));
    }
    /**
