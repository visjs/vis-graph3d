...
(function (global, factory) {
	...
	*/
	...
	var arrayMethodUsesToLength = function (METHOD_NAME, options) {
	  ...
	  return !!method && !fails(function () {
	    ...
	    var addTrap = function (key) {
	      if (ACCESSORS) defineProperty(O, key, {
	        enumerable: true,
	        get: thrower
	      });else O[key] = 1;
	    };
	...
	var entries_1 = function (it) {
	  var own = it.entries;
	  return it === ArrayPrototype$5 || it instanceof Array && own === ArrayPrototype$5.entries // eslint-disable-next-line no-prototype-builtins
	...
	var values_1 = function (it) {
	  var own = it.values;
	  return it === ArrayPrototype$6 || it instanceof Array && own === ArrayPrototype$6.values // eslint-disable-next-line no-prototype-builtins
	...
	var keys_1 = function (it) {
	  var own = it.keys;
	  return it === ArrayPrototype$8 || it instanceof Array && own === ArrayPrototype$8.keys // eslint-disable-next-line no-prototype-builtins
	...
	*/
	...
	var METHOD_REQUIRED = objectToString$1 !== {}.toString;
	...
	var arrayForEach$1 = sloppyArrayMethod('forEach') ? function forEach(callbackfn
	/* , thisArg */
	) {
	...
	var IS_CONCAT_SPREADABLE_SUPPORT$1 = v8Version >= 51 || !fails$1(function () {
	  var array = [];
	...
	function () {
	  ...
	  createClass(DataStream, [{
	        ...
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              ...
	              _context.prev = 3;
	              _iterator = getIterator$1(this._pairs);
	        ...
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            case 0:
	              ...
	              _context2.prev = 3;
	              _iterator2 = getIterator$1(this._pairs);
	        ...
	        while (1) {
	          switch (_context3.prev = _context3.next) {
	            case 0:
	              ...
	              _context3.prev = 3;
	              _iterator3 = getIterator$1(this._pairs);
	        ...
	        while (1) {
	          switch (_context4.prev = _context4.next) {
	            case 0:
	              ...
	              _context4.prev = 3;
	              _iterator4 = getIterator$1(this._pairs);
	    ...
	    value: function toObjectMap() {
	      ...
	      try {
	        for (var _iterator5 = getIterator$1(this._pairs), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	    ...
	    value: function distinct(callback) {
	      ...
	      try {
	        for (var _iterator6 = getIterator$1(this._pairs), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	    ...
	    value: function filter(callback) {
	      ...
	      return new DataStream(defineProperty$7({}, iterator$2,
	      /*#__PURE__*/
	          ...
	          while (1) {
	            switch (_context7.prev = _context7.next) {
	              case 0:
	                ...
	                _context7.prev = 3;
	                _iterator7 = getIterator$1(pairs);
	    ...
	    value: function forEach(callback) {
	      ...
	      try {
	        for (var _iterator8 = getIterator$1(this._pairs), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
	          ...
	          while (1) {
	            switch (_context8.prev = _context8.next) {
	              case 0:
	                ...
	                _context8.prev = 3;
	                _iterator9 = getIterator$1(pairs);
	    ...
	    value: function reduce(callback, accumulator) {
	      ...
	      try {
	        for (var _iterator10 = getIterator$1(this._pairs), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
	    ...
	    value: function sort(callback) {
	      ...
	      return new DataStream(defineProperty$7({}, iterator$2, function () {
	        ...
	        return getIterator$1(sort$2(_context9 = toConsumableArray(_this._pairs)).call(_context9, function (_ref3, _ref4) {
	...
	function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context9; forEach$2(_context9 = ownKeys$2(Object(source), true)).call(_context9, function (key) { defineProperty$7(target, key, source[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source)); } else { var _context10; forEach$2(_context10 = ownKeys$2(Object(source))).call(_context10, function (key) { defineProperty$4(target, key, getOwnPropertyDescriptor$3(source, key)); }); } } return target; }
	...
	function (_DataSetPart) {
	  ...
	  createClass(DataSet, [{
	    ...
	    value: function max(field) {
	      ...
	      try {
	        for (var _iterator = getIterator$1(values$2(_context5 = this._data).call(_context5)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var _context5;
	    ...
	    value: function min(field) {
	      ...
	      try {
	        for (var _iterator2 = getIterator$1(values$2(_context6 = this._data).call(_context6)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          var _context6;
